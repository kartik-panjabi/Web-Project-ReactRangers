...
export default function ViewLease({ params }: { params: Promise<{ id: string }> }) {
    ...
    const handleRequestPayment = () => {
        router.push(`/dashboard/landlord/leases/${resolvedParams.id}/request-payment`);
    };
    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow mb-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p className="font-medium">{lease.paymentDueDay}th of each month</p>
                    </div>
                    {lease.advancedPayment && (
                        <>
                            ...
                            <div>
                                ...
                                <p className="font-medium capitalize">{lease.advancedPayment.status}</p>
                            </div>
                        </>
                    )}
                </div>
            ...
            {!lease.landlordSignature && lease.status === 'pending_landlord_signature' && (
                <div className="bg-white p-6 rounded-lg shadow mb-6">
            ...
            {lease.landlordSignature && (
                <div className="bg-white p-6 rounded-lg shadow mb-6">
                    ...
                    <div className="border rounded-lg p-4">
                        <img 
                            src={lease.landlordSignature.signature} 
                            alt="Your signature" 
                            className="max-w-full h-auto"
                        />
                        <p className="text-sm text-gray-500 mt-2">
                            Signed on: {new Date(lease.landlordSignature.signedAt).toLocaleString()}
                        </p>
                    </div>
                </div>
            )}

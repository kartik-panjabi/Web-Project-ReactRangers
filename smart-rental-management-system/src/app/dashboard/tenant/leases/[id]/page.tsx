    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow mb-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">{lease.landlord.email}</p>
                    </div>
                    <div>
            ...
            {lease.landlordSignature && (
                <div className="bg-white p-6 rounded-lg shadow mb-6">
                    <h2 className="text-xl font-semibold mb-4">Landlord's Signature</h2>
            ...
            {!lease.tenantSignature && lease.status === 'pending_tenant_signature' && (
                <div className="bg-white p-6 rounded-lg shadow mb-6">
